...
```bash
python3 ../../scripts/init_deck_workspace.py --workspace . --title "时序遥感耕地分割：从时间融合到通用先验注入" --style-preset <preset> --user-prompt "Original user request"
```
