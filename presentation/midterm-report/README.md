...
This workspace is the saved authoring source for the `galileo` deck.
...
```bash
python3 ../../scripts/init_deck_workspace.py --workspace . --title "冻结 Galileo 表征上的作物语义分割解码器研究" --style-preset <preset> --user-prompt "Original user request"
```
